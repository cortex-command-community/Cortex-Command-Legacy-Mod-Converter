...
function Update(self)
	if self.Fuze then
		if self.Fuze:IsPastSimMS(2500+self.random) then
...
function Destroy(self)
	...
	if ActivityMan:ActivityRunning() then -- for some reason the game crashes if you switch activities (i.e. start a new one) while this item is active
